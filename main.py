...
def on_closing():
    if mess.askyesno("Quit", "Do you want to quit?"):
        window.destroy()
def contact():
    mess._show(title="Contact Me",message="If you have any queries, feel free to ask at 'mdwamique60@gmail.com'")

def about():
    mess._show(title="About",message="Attendance System is designed by, Md. Wamique; for Microsoft Engage 2022")
...
def check_haarcascadefile():
    ...
    if exists:
        ...
        mess._show(title='file missing', message='some file is missing.Please contact me for help')
        window.destroy()
...
def TrainImages():
    ...
    message1.configure(text=res)
    message.configure(text='Total saved details till now : ' + str(ID[0]))
...
frame1 = tkinter.Frame(window, bg="skyblue")
frame1.place(relx=0.11, rely=0.15, relwidth=0.39, relheight=0.80)

frame2 = tkinter.Frame(window, bg="skyblue")
frame2.place(relx=0.51, rely=0.15, relwidth=0.39, relheight=0.80)

fr_head1 = tkinter.Label(frame1, text="Register a New Student", fg="white",bg="black" ,font=('times', 17, ' bold ') )
...
lbl = tkinter.Label(frame1, text="Enter Registration Number",width=26  ,height=1  ,fg="black"  ,bg="skyblue" ,font=('times', 17, ' bold ') )
lbl.place(x=0, y=55)
...
lbl2 = tkinter.Label(frame1, text="Enter your Name",width=22  ,fg="black"  ,bg="skyblue" ,font=('times', 17, ' bold '))
...
message0=tkinter.Label(frame1,text="Follow the steps...",bg="skyblue" ,fg="black"  ,width=39 ,height=1,font=('times', 16, ' bold '))
message0.place(x=7,y=275)

message1 = tkinter.Label(frame1, text="1)Take Images  ===> 2)Save Profile" ,bg="skyblue" ,fg="black"  ,width=39 ,height=1, activebackground = "yellow" ,font=('times', 15, ' bold '))
...
lbl3 = tkinter.Label(frame2, text="Attendance Table",width=20  ,fg="black"  ,bg="skyblue"  ,height=1 ,font=('times', 17, ' bold '))
